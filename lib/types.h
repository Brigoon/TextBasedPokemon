...
namespace Types {
    ...
    extern Normal normalType;
    extern Fire fireType;
    extern Water waterType;
    extern Electric electricType;
    extern Grass grassType;
    extern Ice iceType;
    extern Fighting fightingType;
    extern Poison poisonType;
    extern Ground groundType;
    extern Flying flyingType;
    extern Psychic psychicType;
    extern Bug bugType;
    extern Rock rockType;
    extern Ghost ghostType;
    extern Dragon dragonType;
    extern Dark darkType;
    extern Steel steelType;
    extern Fairy fairyType;
}